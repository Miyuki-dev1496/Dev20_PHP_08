...
<header>
    ...
    <ul class="nav-list2">
      <a id="login-show" class="nav-icon"><img class="icon01" src="image/icon01.png"></a>
      <li>
...
<main>
<div class="login_wrapper" id="login-modal">
        <div class="modal">
          <div id="profile-form">
            <form method="post" action="login_act.php">
              <li class="profile">
                <a href="mypage.php"><img class="img03" src="image/profile.png" width=30px></a>
                <p class="text">My Page</p>
              </li>
              <li class="profile">
                <a href="u_view.php"><img class="img03" src="image/setting.png" width=30px></a>
                <p class="text">Setting</p>
              </li>
              <hr>
              <li class="profile02">
                <a class="text02" href="logout.php">Log Out</a>
              </li>
            </form>
          </div>
        </div> 
...
<div class="account_wrapper"> 
  <div class="account">
      <img class="img" src="image/ac_img.png" width=60px>
